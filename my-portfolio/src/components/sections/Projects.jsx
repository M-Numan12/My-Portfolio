...
const featured = [
  ...
  { title: "AI Trade Journal", subtitle: "Full-stack SaaS concept", image: "/project-previews/ai-trade-journal.svg", tags: ["Next.js", "PostgreSQL", "OpenAI API"], result: "Combines trade tracking, performance analytics and AI-assisted chart feedback in one workflow.", link: "https://github.com/M-Numan12/AI-Trade-Journal" },
  { title: "Real-Time Bus Tracking", subtitle: "Android location experience", image: "/project-previews/bus-tracking.svg", tags: ["Kotlin", "Google Maps", "GPS"], result: "Explores live route visibility, stop information and ETA updates for safer student transport.", link: "https://github.com/M-Numan12/Bus_Tracking_App" },
  { title: "Web Services Lab", subtitle: "48 interactive business demos", image: "/project-previews/web-services-lab.svg", tags: ["Websites", "WordPress", "Lead generation"], result: "Shows working visitor journeys for company sites, booking, commerce and business applications.", link: "https://numan-web-service-projects.vercel.app/" },
];
